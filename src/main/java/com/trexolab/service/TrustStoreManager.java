 ...
 * 2. Manual certificates (~/.trexo-pdf-signer/trusted-certs/) - user-managed
 *
...
public class TrustStoreManager {
    ...
    // User certificates directory (from AppConstants)
    private static final String USER_CERTS_DIR = AppConstants.TRUSTED_CERTS_PATH.toString();
