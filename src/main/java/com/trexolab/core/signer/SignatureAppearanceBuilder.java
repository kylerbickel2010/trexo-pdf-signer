...
public class SignatureAppearanceBuilder {
    ...
    private String generateFieldName(String prefix, int pageNumber) {
        ...
        String name = String.format("%s__P_%d_%06d", prefix, pageNumber, randomSuffix);

        // 1. Replace all non [A-Za-z0-9_] with underscore, and collapse multiple underscores into one, and the removing leading/trailing underscores
        return name
