...
public class CertificateListDialog extends JDialog {
    ...
    private JPanel createFooterPanel() {
        ...
        JButton chooseButton = getChooseCertificateButton();
    ...
    private JButton getChooseCertificateButton() {
        ...
        choose.addActionListener(e -> {
            if (selectedCard != null || selectedPfxFile != null) {
                ...
                String message;
                if (!ConfigManager.isPFXStoreActive()) {
                    message = "<b>No signing device or keystore detected.</b><br><br>" +
                            (AppConstants.isWindow
                                    ? "Please connect a hardware token <i>(USB token or smart card)</i>, or "
                                    : "Please ") +
                            "enable a supported keystore such as <b>PFX, P12, or PKCS#11</b> " +
                            "to proceed with the signing operation.";
                } else {
                    message ="<b>No certificate selected.</b><br><br>" +
                            "Please select a valid certificate to continue with the signing process.";
                }

                DialogUtils.showWarning(this, "Action Required", message);
