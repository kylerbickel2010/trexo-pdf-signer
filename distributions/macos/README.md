# Trexo PDF Signer - macOS Build Instructions
...
ls -lh target/Trexo PDF Signer.jar
```
...
- `Trexo PDF Signer.app` - 4GB max memory

The bundle is self-contained with:
- The Trexo PDF Signer JAR file
- Bundled Java 8 JRE
...
This creates `output/trexo-pdf-signer-x64-macos.dmg` containing:
- Trexo PDF Signer.app (4GB max memory)
...
├── trexo-pdf-signer.icns         # App icon
...
│   ├── Trexo PDF Signer.app
│   └── trexo-pdf-signer-x64-macos.dmg
└── README.md              # This file
```
...
The launcher script (`run-trexo-pdf-signer`) handles both structures automatically.
...
```bash
./diagnose-app.sh "Trexo PDF Signer.app"
```
...
sudo xattr -dr com.apple.quarantine "/Applications/Trexo PDF Signer.app"
```
...
- Trexo PDF Signer Repository: https://github.com/trexolab-solution/trexo-pdf-signer
- Report Issues: https://github.com/trexolab-solution/trexo-pdf-signer/issues
