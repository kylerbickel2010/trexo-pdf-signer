#!/bin/bash
# ============================================================================
# Trexo PDF Signer - macOS Diagnostic Script
# TrexoLab - https://trexolab.com
# ============================================================================
#
# This script diagnoses issues with the Trexo PDF Signer macOS app installation.
...
#
# Example:
#   ./diagnose-app.sh "TrexoPDFSigner.app"
#
# ============================================================================

set -e

APP_NAME="${1:-TrexoPDFSigner.app}"
APP_PATH="/Applications/$APP_NAME"

echo "============================================================================"
echo " Trexo PDF Signer Diagnostic Tool"
echo "============================================================================"
echo " App: $APP_NAME"
echo "============================================================================"
echo ""
...
if [ ! -d "$APP_PATH" ]; then
    ...
    echo ""
    echo "   Available Trexo PDF Signer apps in /Applications:"
    ls -1 /Applications/ | grep -i "trexo" || echo "   (none found)"
    exit 1
fi
...
# Check for JAR file
echo "4. Checking for TrexoPDFSigner.jar..."
JAR_FILE="$RESOURCES_DIR/TrexoPDFSigner.jar"
if [ ! -f "$JAR_FILE" ]; then
    echo "   ✗ ERROR: TrexoPDFSigner.jar not found"
    exit 1
fi
JAR_SIZE=$(du -h "$JAR_FILE" | cut -f1)
echo "   ✓ TrexoPDFSigner.jar found (size: $JAR_SIZE)"
echo ""
...
if [ ! -d "$JRE_DIR" ]; then
    ...
    echo "      https://github.com/trexolab-solution/trexo-pdf-signer/releases/latest"
    echo ""
...
LAUNCHER="$APP_PATH/Contents/MacOS/run-trexo-pdf-signer"
if [ ! -f "$LAUNCHER" ]; then
...
echo "   3. Report the issue at: https://github.com/trexolab-solution/trexo-pdf-signer/issues"
echo ""
echo "============================================================================"
