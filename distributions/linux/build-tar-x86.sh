#!/bin/bash
# ============================================================================
# Trexo PDF Signer - Portable TAR.GZ Package Builder (x86/i386)
# TrexoLab - https://trexolab.com
# ============================================================================
#
# This script creates a portable .tar.gz package for any 32-bit Linux distribution.
#
# Prerequisites:
...
#
# Output:
#   ./output/trexo-pdf-signer-x86-linux.tar.gz
# ============================================================================
...
echo "============================================================================"
echo " Building Trexo PDF Signer Portable Package (tar.gz) - x86/i386"
echo "============================================================================"
...
cp "$SCRIPT_DIR/trexo-pdf-signer-x86" "$PACKAGE_DIR/trexo-pdf-signer"
chmod +x "$PACKAGE_DIR/trexo-pdf-signer"

# Copy JRE (x86 version)
echo "Copying bundled JRE (x86)..."
cp -r "$SCRIPT_DIR/jre8-x86" "$PACKAGE_DIR/"
chmod +x "$PACKAGE_DIR/jre8-x86/bin/"*
...
#!/bin/bash
# ============================================================================
# Trexo PDF Signer - Linux Installation Script (x86/i386)
# TrexoLab - https://trexolab.com
# ============================================================================
...
echo ""
echo -e "${BLUE}============================================================================${NC}"
echo -e "${BLUE} Trexo PDF Signer Installation Script (x86/i386)${NC}"
echo -e "${BLUE}============================================================================${NC}"
echo ""
...
if [ -n "$INSTALLED_VERSION" ]; then
    ...
    echo " Installing Trexo PDF Signer $NEW_VERSION (x86/i386)..."
fi
...
chmod +x "$INSTALL_DIR/jre8-x86/bin/"* 2>/dev/null || true
...
echo ""
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN} Trexo PDF Signer $NEW_VERSION (x86/i386) has been installed successfully!${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo ""
echo " Launch from:"
...
============================================================================
 Trexo PDF Signer - Portable Linux Package (x86/i386 - 32-bit)
 TrexoLab - https://trexolab.com
============================================================================
...
Option 1: Using the install script (recommended)
   tar -xzf trexo-pdf-signer-x86-linux.tar.gz
   cd trexo-pdf-signer-*
   sudo ./install.sh

Option 2: Manual extraction
   tar -xzf trexo-pdf-signer-x86-linux.tar.gz -C /opt/
...
cd "$BUILD_DIR"
tar -czf "$OUTPUT_DIR/trexo-pdf-signer-x86-linux.tar.gz" "${APP_NAME}-${APP_VERSION}"
...
echo "============================================================================"
echo " Output: $OUTPUT_DIR/trexo-pdf-signer-x86-linux.tar.gz"
echo " Size: $(du -h "$OUTPUT_DIR/trexo-pdf-signer-x86-linux.tar.gz" | cut -f1)"
echo "============================================================================"
