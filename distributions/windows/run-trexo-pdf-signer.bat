@echo off
REM ============================================================================
REM Trexo PDF Signer - Launcher Script for Windows
REM TrexoLab - https://trexolab.com
REM ============================================================================
REM
REM This script launches Trexo PDF Signer with the bundled JRE 8 x64.
...
REM
REM Usage:
REM   run-trexo-pdf-signer.bat                    # Normal profile
REM   run-trexo-pdf-signer.bat large              # Large profile
REM   run-trexo-pdf-signer.bat xlarge             # Extra Large profile
REM   run-trexo-pdf-signer.bat "C:\path\to\file.pdf"  # Open PDF (normal profile)
REM   run-trexo-pdf-signer.bat large "C:\path\to\file.pdf"  # Open PDF (large profile)
REM ============================================================================
...
REM ============================================================================
REM Validate bundled Java runtime exists
REM ============================================================================
set "JAVA_EXE=!SCRIPT_DIR!\jre8-x64\bin\javaw.exe"
if not exist "!JAVA_EXE!" (
    set "JAVA_EXE=!SCRIPT_DIR!\jre8-x64\bin\java.exe"
)
...
REM ============================================================================
set "JAR_FILE=!SCRIPT_DIR!\TrexoPDFSigner.jar"
...
echo ============================================================================
echo.
echo  The bundled Java 8 x64 runtime was not found at:
echo    "!SCRIPT_DIR!\jre8-x64\bin\java.exe"
echo.
echo  Please reinstall Trexo PDF Signer to restore the Java runtime.
echo.
echo ============================================================================
pause
endlocal
...
echo    "!JAR_FILE!"
echo.
echo  Please reinstall Trexo PDF Signer.
echo.
echo ============================================================================
pause
endlocal
