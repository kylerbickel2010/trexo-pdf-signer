...
export const diagrams: Diagram[] = [
  {
    ...
    description: 'High-level overview of Trexo PDF Signer system components and their relationships. Shows the main modules including PDF processing, certificate management, and signature validation.',
  ...
  },
  {
    ...
    description: 'Shows how different components of Trexo PDF Signer communicate with each other, including PKCS#11 integration and certificate store access.',
    category: 'component',
  },
];
