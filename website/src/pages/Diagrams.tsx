...
export function Diagrams() {
  ...
  const imageGalleryStructuredData = structuredDataGenerators.imageGallery(
    diagrams.map((d) => ({
      url: `https://trexolab-solution.github.io/trexo-pdf-signer${d.src}`,
      title: d.title,
  ...
  const breadcrumbStructuredData = structuredDataGenerators.breadcrumb([
    ...
    { name: 'Architecture Diagrams', url: 'https://trexolab-solution.github.io/trexo-pdf-signer/#/diagrams' },
  ]);

  const techArticleStructuredData = structuredDataGenerators.techArticle(
    'Trexo PDF Signer Architecture Diagrams - System Design Documentation',
    'Technical architecture diagrams for Trexo PDF Signer. Includes system architecture, workflow diagrams, component interaction, and sequence diagrams.',
    'https://trexolab-solution.github.io/trexo-pdf-signer/diagrams/System_Architecture_Diagram.svg'
  );
  ...
  return (
    <>
      <SEO
        ...
        description="Explore Trexo PDF Signer technical architecture and workflow diagrams. System design documentation including component interaction, sequence diagrams, and PDF signing workflow."
        keywords="Trexo PDF Signer architecture, system design, technical diagrams, PDF signing workflow, component diagram, sequence diagram, software architecture, UML diagrams"
        url="https://trexolab-solution.github.io/trexo-pdf-signer/#/diagrams"
        image="https://trexolab-solution.github.io/trexo-pdf-signer/diagrams/System_Architecture_Diagram.svg"
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mb-6">
                Explore the technical architecture and workflow diagrams of Trexo PDF Signer. Use scroll to zoom at cursor position, drag to pan when zoomed.
              </p>
