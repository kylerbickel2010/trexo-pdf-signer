...
import { ORG, APP_NAME, APP_CONFIG, GITHUB_URL } from '@/utils/constants';
...
export function Projects() {
  ...
  const breadcrumbStructuredData = structuredDataGenerators.breadcrumb([
    ...
    { name: 'Projects', url: `${APP_CONFIG.baseUrl}/#/projects` },
  ]);
  ...
  return (
    <>
      <SEO
        ...
        url="https://trexolab-solution.github.io/trexo-pdf-signer/#/projects"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {PROJECTS.map((project, index) => (
                <a
                  ...
                  className={`glass-card p-6 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 group animate-fade-in-up ${project.featured ? 'ring-2 ring-primary/30' : ''
                    }`}
