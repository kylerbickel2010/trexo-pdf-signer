...
const SEARCHABLE_CONTENT: SearchResult[] = [
  // Pages
  { id: 'home', title: 'Home', description: 'Trexo PDF Signer software overview', category: 'Pages', url: '/', icon: FileText, type: 'page', keywords: ['main', 'start', 'landing'] },
  { id: 'installation', title: 'Installation Guide', description: 'How to install Trexo PDF Signer on Windows, Linux, macOS', category: 'Pages', url: '/installation', icon: Download, type: 'page', keywords: ['setup', 'install', 'download', 'get started'] },
  { id: 'documentation', title: 'Documentation', description: 'Complete guide to Trexo PDF Signer features and configuration', category: 'Pages', url: '/documentation', icon: BookOpen, type: 'page', keywords: ['docs', 'guide', 'manual', 'help'] },
  { id: 'diagrams', title: 'Architecture Diagrams', description: 'Visual diagrams of Trexo PDF Signer architecture', category: 'Pages', url: '/diagrams', icon: FileText, type: 'page', keywords: ['charts', 'flow', 'visual'] },

  // Home Sections
  { id: 'features', title: 'Features', description: 'Key features of Trexo PDF Signer', category: 'Sections', url: '/#features', icon: FileText, type: 'section', keywords: ['capabilities', 'functions'] },
  { id: 'gallery', title: 'Screenshot Gallery', description: 'See Trexo PDF Signer in action', category: 'Sections', url: '/#gallery', icon: FileText, type: 'section', keywords: ['images', 'screenshots', 'preview'] },
  ...
  { id: 'download', title: 'Download', description: 'Download Trexo PDF Signer for your platform', category: 'Sections', url: '/#download', icon: Download, type: 'section', keywords: ['get', 'install'] },
  ...
  { id: 'install-windows', title: 'Windows Installation', description: 'Install Trexo PDF Signer on Windows with bundled Java', category: 'Installation', url: '/installation#windows', icon: Download, type: 'section', keywords: ['windows', 'win', 'exe', 'installer'] },
  { id: 'install-linux', title: 'Linux Installation', description: 'Install Trexo PDF Signer on Ubuntu, Debian, Fedora, Arch', category: 'Installation', url: '/installation#linux', icon: Download, type: 'section', keywords: ['linux', 'ubuntu', 'debian', 'fedora', 'arch', 'deb', 'rpm'] },
  { id: 'install-macos', title: 'macOS Installation', description: 'Install Trexo PDF Signer on macOS with DMG installer', category: 'Installation', url: '/installation#macos', icon: Download, type: 'section', keywords: ['mac', 'macos', 'dmg', 'apple'] },
