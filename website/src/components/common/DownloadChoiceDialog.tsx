...
const GITHUB_RELEASES = 'https://github.com/trexolab-solution/trexo-pdf-signer/releases';
const GITHUB_REPO = 'https://github.com/trexolab-solution/trexo-pdf-signer';
const SOURCEFORGE_PROJECT = 'https://sourceforge.net/projects/trexo-pdf-signer/';
const SOURCEFORGE_REVIEWS = 'https://sourceforge.net/projects/trexo-pdf-signer/reviews/';
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-white text-sm mb-1">
                        {downloadSource === 'github'
                          ? "Enjoying Trexo PDF Signer? Star us on GitHub!"
                          : "Love Trexo PDF Signer? Leave a review!"}
                      </h3>
                      <p className="text-xs text-slate-400 leading-relaxed">
                        {downloadSource === 'github'
                          ? "Your star helps others discover Trexo PDF Signer and motivates our development. It only takes a second!"
